...
from app.routers import portfolios, market_data, analysis, chart_analysis, dcf, sec_filings, pdf_research
...
app.include_router(pdf_research.router, prefix="/api/v1/pdf-research", tags=["PDF Research"])
