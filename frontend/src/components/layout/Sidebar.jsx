...
import { LayoutDashboard, Briefcase, Radio, BrainCircuit, ImagePlus, Calculator, FileText, FileSearch } from 'lucide-react'
...
const links = [
  ...
  { to: '/pdf-research', label: 'PDF Research', icon: FileSearch },
]
